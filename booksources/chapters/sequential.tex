...
As an obvious optimization, the computed value of \n{a} could be left in register.
...
\begin{figure}[ht]
  \includegraphics[scale=.6]{associativity}
...
\indextermbus{LINPACK}{benchmark}~\cite{Dongarra1987LinpackBenchmark}
of the `top500';
...
\indexterm{peak performance} on the Linpack benchmark.
...
\indexacf{OS}. However, sometimes the presence of the \ac{OS} can be
