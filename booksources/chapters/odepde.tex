...
\acp{PDE}\index{elliptic problems} have the form 
\begin{equation}
  Au_{xx}+Bu_{yy}+\hbox{lower order terms} =0
\end{equation}
...
The \indexterm{Laplace equation}
\index{Poisson equation|seealso{Laplace equation}}
(section~\ref{sec:poisson}) is the standard example of
this type.

\Level 1 {The Laplace equation in one space dimension}
\label{sec:poisson}
\label{sec:1dbvp}
...
\begin{equation}
 ...
 \end{equation}
is called the \indextermdef{Poisson equation}, in this case defined on
the unit square.
The case of $f\equiv0$ is called the \indextermdef{Laplace equation}.
...
\Level 1 {The Laplace equation in two space dimensions}
\label{sec:2dbvp}
