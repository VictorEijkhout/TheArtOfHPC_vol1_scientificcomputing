...
For this, the concept of \indextermsubdef{amortized}{complexity}
has been coined~\cite{Tarjan:amortized}.

A common example of amortized complexity is dynamically extending an array.
...
Since writing $n$ elements has complexity $O(n)$,
we say that the \indextermsub{amortized}{complexity}
