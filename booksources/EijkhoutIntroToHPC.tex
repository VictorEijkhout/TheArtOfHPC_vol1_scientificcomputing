...
%% tikz figures have trouble with aux files, so include:
%% \nofiles
...
% fancy text stuff
% requires xetex or luatex
\usepackage{fontspec}
\newcommand\latexengine{,xetex}
%\newcommand\latexengine{,pdftex}
\setmainfont[
  Extension=.otf,
  UprightFont={*-Regular},
  BoldFont={*-Bold},
...
\input exmacs
\input commonmacs
\def\TutorialsSubDir{tutorials}
\input commonbookmacs
\input bookoutline
\newif\ifVolumeOne \VolumeOnetrue
\input bookmacs
\input displaymacs
%% \input bookoutline
