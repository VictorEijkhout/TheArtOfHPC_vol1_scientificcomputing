...
The output also gives an indication where in the source
that allocation was performed, which is usually enough to pinpoint the problem.
...
(just imagine allocating, and not free'ing, in a loop; section~\ref{sec:memory-leak}).
%
