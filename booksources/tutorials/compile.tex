...
\begin{itemize}
\item \n{hello.i}: a text file where all preprocessor directives have been inlined.
...
\end{lstlisting}
et cetera.
\item \n{hello.s}: the \indextermbus{assembly}{listing} of your program.
...
LFB10:
        stp     x29, x30, [sp, -16]!    
\end{lstlisting}
\item \n{hello.o}: the object file, containing actual machine language.
