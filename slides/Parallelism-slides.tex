...
\Level 2 {LU factorization analysis}
...
\begin{exerciseframe}{Critical path}
  \input{ex:gauss-critical}
\end{exerciseframe}
...
\begin{exerciseframe}{Parallel execution}
  \input{ex:gauss-n2parallel}  
\end{exerciseframe}
...
\begin{exerciseframe}{Memory scaling, case 1: Faster processor}
  \input{ex:gauss-f2f}
\end{exerciseframe}
...
\begin{exerciseframe}{Memory scaling, case 2: More processors}
  \input{ex:gauss-p2p}
\end{exerciseframe}
...
\begin{exerciseframe}{Broadcast algorithm}
...
\begin{exerciseframe}{Switch contention}
