...
\message {defining IMP}\acitem {IMP}{Integrative Model for Parallelism}
...
\message {defining SSOR}\acitem {SSOR}{Symmetric Successive Over-Relaxation}
...
\message {defining TDD}\acitem {TDD}{Test-Drive Development}
