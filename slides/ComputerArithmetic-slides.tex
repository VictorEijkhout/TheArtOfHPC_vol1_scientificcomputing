...
\begin{numberedframe}{Bit operations}
  \input{frames/sl:bit-and-or}
\end{numberedframe}

\begin{exerciseframe}{Bit operations}
  \label{ex:bit-even}
...
\begin{exerciseframe}{Powers of two}
  \label{ex:two-powers}
...
\begin{exerciseframe}{Integer overflow}
...
\begin{exerciseframe}{Floating point overflow}
...
\small
  ...
  \begin{array}{| l || l || l |}
    ...
    \hline
    &e=e_1\cdots e_8 &s=s_1\dots s_{23}\\
    \hline
...
\begin{exerciseframe}{Float vs Int}
...
\begin{exerciseframe}{Machine epsilon}
...
\begin{numberedframe}{Limits header}
  \input{frames/sl:stl-limits}
\end{numberedframe}

\begin{numberedframe}{Int limits}
  \input{frames/sl:std-limit-int}
\end{numberedframe}

\begin{numberedframe}{Float limits}
  \input{frames/sl:float-limits}
\end{numberedframe}
...
\begin{numberedframe}{Numerical test}
\begin{equation}
  \begin{array}{rrrrr}
...
\begin{exerciseframe}{Fixed-point iteration}
...
Half and quad precision,

bfloat16 and other exotic formats
\end{numberedframe}
