...
\begin{numberedframe}{Simple compilation: files involved}
  \begin{itemize}
  \item Use a text editor to create a program file: \n{myprogram.cpp}
  \item Use a compiler to translate that to an executable: \n{myprogram}
  \item \ldots~and then run that file.
  \end{itemize}
\end{numberedframe}

\begin{numberedframe}{Simple compilation: the process}
...
\begin{numberedframe}{Exercise 1, C++ version}
  ...
  \ListStrippedSource{../code/compilecxx}{hello.cxx}
\end{numberedframe}
...
\begin{multicols}{2}
  Main program: \n{fooprog.cxx}
  \ListStrippedSource{../code/compilecxx}{fooprog.cxx}
  \columnbreak
  Subprogram: \n{foosub.cxx}
  \ListStrippedSource{../code/compilecxx}{foosub.cxx}
\end{multicols}
\endgroup
\end{numberedframe}
...
\item you may also come across the \n{rpath=} syntax,
